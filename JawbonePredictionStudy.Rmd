...
The model has an out of bag error of ***********2.24********** %. Since we are using a random forest, the out of sample error estimate is provided by the 'out of bag estimate of error rate' provided by the model.
...
The overall accuracy of this model as tested on the testing set is an impressive 97.9%!
